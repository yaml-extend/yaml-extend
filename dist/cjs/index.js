...
function tokenizeKeyValue(input, argsTok, tempState, depth, tokenizeTextFunc) {
    ...
    while (true) {
        ...
        tokens.push(...toks);
        if (((_a = tokens[tokens.length - 1]) === null || _a === void 0 ? void 0 : _a.type) === exports.KeyValueTokenType.EOF)
            break;
    }
...
function readQuoted(state, tempState, parentTok) {
    ...
    const linePos = getLinePosFromPos(tempState.lineStarts, pos);
    const tok = {
        type: state.afterEqual ? exports.KeyValueTokenType.VALUE : exports.KeyValueTokenType.KEY,
        raw: readValue.raw,
        text: readValue.text,
        value,
        quoted: true,
...
function tokenizeArgs(input, exprTok, tempState, depth, tokenizeTextFunc) {
    ...
    while (true) {
        ...
        tokens.push(...toks);
        if (tokens[tokens.length - 1].type === exports.ArgsTokenType.EOF)
            break;
    }
    // resolve any value tokens using text tokenizer
    for (const t of tokens)
...
function readQuotedPath(state, tempState, parentTok) {
    ...
    const linePos = getLinePosFromPos(tempState.lineStarts, pos);
    const tok = {
        type: state.baseDefined ? exports.ExprTokenType.PATH : exports.ExprTokenType.BASE,
        raw: readValue.raw,
        text: readValue.text,
        value,
        quoted: true,
...
function tokenizeText(input, keyValueTok, tempState, depth = 0) {
    ...
    while (true) {
        ...
        tokens.push(...toks);
        if (tokens[tokens.length - 1].type === exports.TextTokenType.EOF)
            break;
    }
    // increment depth
    depth++;
...
Object.defineProperty(exports, "Alias", {
    enumerable: true,
    get: function () { return yaml.Alias; }
});
Object.defineProperty(exports, "Scalar", {
    enumerable: true,
    get: function () { return yaml.Scalar; }
});
...
Object.defineProperty(exports, "YAMLMap", {
    enumerable: true,
    get: function () { return yaml.YAMLMap; }
});
Object.defineProperty(exports, "YAMLSeq", {
    enumerable: true,
    get: function () { return yaml.YAMLSeq; }
});
