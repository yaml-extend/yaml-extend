...
export { Alias, CollectionTag, CreateNodeOptions, DocumentOptions, ParseOptions, Scalar, ScalarTag, Schema, SchemaOptions, TagId, Tags, ToJSOptions, ToStringOptions, YAMLMap, YAMLSeq } from 'yaml';
